...
public class AncapStates extends JavaPlugin {
    ...
    private void registerCommands() {
        ...
        ancapstates.setExecutor(new ASCommand());
        ancapstates.setTabCompleter(new ASCommand());
